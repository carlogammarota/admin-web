        ...
        <div class="relative w-full h-full max-w-md md:h-auto m-auto mt-24">
            <div class="relative bg-gray-100 rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <button data-modal-hide="popup-modal" @click="ConfirmDeleteItem()" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        Eliminar
                    </button>

                    <button data-modal-hide="popup-modal" @click="modalStatus = false" 
                    type="button" 
