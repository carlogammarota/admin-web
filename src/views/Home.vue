      ...
      <div class="flex flex-row w-full">
        ...
        <div class='hidden lg:flex flex-col justify-between bg-[#ffe85c] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
          <div class="flex items-center justify-start space-x-3">
            ...
            <a href="#" class="font-medium text-xl">Aura Dev</a>
          </div>
          <div class='space-y-5'>
        ...
        <div class="flex flex-1 flex-col items-center justify-center px-10 relative">
          ...
          <div class="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
            ...
            <div class="flex flex-col max-w-md space-y-5">
              <input v-model="email" type="text" placeholder="NOMBRE DE USUARIO"
          ...
          <div class="flex justify-center flex-col m-auto mb-16 text-center text-lg dark:text-slate-200 ">
            <p class="font-bold mb-1">Built by <a href="#" class="underline dark:text-white">Aura Dev</a></p>
